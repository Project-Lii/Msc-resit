...
def main():
    ...
    # Data loading code
    img_paths = glob(r'E:\DataSets\BraTS2020\Brats2018FoulModel2D\testImage_small_artifact\*')
    mask_paths = glob(r'E:\DataSets\BraTS2020\Brats2018FoulModel2D\testMask_small_artifact\*')
